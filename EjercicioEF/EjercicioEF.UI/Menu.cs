using Ejercicio.EF.Data;
using Ejercicio.EF.Entities;
    ...
    public class Menu
    {
        ...
        public void GetMenu()
        {
            ...
            while (aux)
            {
                ...
                Console.WriteLine("3. Consultar una categoría por ID");
                Console.WriteLine("4. Consultar todas los categorías");
                ...
                switch (n)
                {
                    ...
                    case 3:
                        ...
                        int idCate = int.Parse(Console.ReadLine());
                        var categoria = categoriesLogic.GetOne(idCate);
                        Console.WriteLine($"\nID: {categoria.CategoryID}," +
                                          $"\nNombre de categoria: {categoria.CategoryName}," +
                    ...
                    case 4:
                        ...
                        {
                            Console.WriteLine($"\nID: {cate.CategoryID}," +
                                              $"\nNombre de categoria : {cate.CategoryName}," +
                    ...
                    case 5:
                        Console.WriteLine("Ingrese una opcion: \n\n" +
                                            ...
                                            "\n\n4)Ingresar categoría" +
                                            "\n5)Modificar categoría por ID" +
                                            "\n6)Eliminar categoría por ID" +
                                            "\n\n7)Volver");
                        ...
                        switch (n2)
                        {
                            ...
                            case 2:
                                ...
                                int idCategoriaAEditar = int.Parse(Console.ReadLine());

                                Categories categoriesAEditar = _northwindContext.Categories.FirstOrDefault(c => c.CategoryID == idCategoriaAEditar);

                                if (categoriesAEditar == null)
                                {
                                    Console.WriteLine("No se encontró ninguna categoría con ese ID.");
                                }
                                else
                                {
                                    Console.WriteLine("Ingrese el nombre de la categoría");
                                    categoriesAEditar.CategoryName = Console.ReadLine();
                                    Console.WriteLine("Ingrese la descripción de la categoría");
                                    categoriesAEditar.Description = Console.ReadLine();
                                    categoriesLogic.Update(categoriesAEditar, idCategoriaAEditar);
                                    Console.WriteLine("La categoría ha sido actualizada exitosamente.");
                                }
                                break;
                            ...
                            case 6:
                                ...
                                int idCategoriaAEliminar = int.Parse(Console.ReadLine());
                                CategoriesLogic categoriesLogic1 = new CategoriesLogic();
                                categoriesLogic1.Delete(idCategoriaAEliminar);
                                Console.WriteLine("Empleado borrado correctamente");
                                break;
                        }
                        break;
